...
public class UserEnt {
    ...
    public UserEntRole getRole() { return role; }
    public void setRole(UserEntRole role) { this.role = role; }
    ...
    public String toString() {
        return "UserEnt{id='" + id + "', username='" + username + "', name='" + name + "', active=" + active + ", role=" + role + '}';
    }
}
