package pl.hardstyl3r.userservice.soap.config;
...
import pl.hardstyl3r.userservice.soap.JwtSoapInterceptor;
...
public class SoapConfig extends WsConfigurerAdapter {
    ...
    public XsdSchema pasSchema() {
        return new SimpleXsdSchema(new ClassPathResource("xsd/pas-user.xsd"));
    }

    @Bean(name = "pas")
    public DefaultWsdl11Definition pasWsdl(XsdSchema pasSchema) {
        DefaultWsdl11Definition definition = new DefaultWsdl11Definition();
        definition.setPortTypeName("PasUserPort");
