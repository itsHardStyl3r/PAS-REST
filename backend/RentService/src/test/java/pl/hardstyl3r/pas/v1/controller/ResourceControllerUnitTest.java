...
class ResourceControllerUnitTest {
    ...
    void shouldReturnAllResources() throws Exception {
        ...
        when(resourceService.findAll()).thenReturn(List.of(b1, b2));
    ...
    void shouldReturnResourceById() throws Exception {
        ...
        when(resourceService.findById("r1")).thenReturn(Optional.of(resource));
    ...
    void shouldCreateResource() throws Exception {
        ...
        when(resourceService.createResource(any())).thenReturn(created);
