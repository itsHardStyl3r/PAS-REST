...
public class AllocationController {
    ...
    public AllocationController(AllocationService allocationService, MessageSource messageSource, LocaleResolver localeResolver) {
    ...
    @GetMapping
    public String listAllocations(Model model, HttpServletRequest request) {
        ...
        model.addAttribute("pageTitle", messageSource.getMessage("breadcrumbs.allocations", null, localeResolver.resolveLocale(request)));
